...
public class StudentService implements IStudentService
{
	...
	public void createStudent(Student student)
	{
		...
		WebResource webResource = client.resource("http://localhost:8080/gestionWebService-0.0.1-SNAPSHOT/rest/studentService/createStudent");
	...
	public Student getStudent(int id)
	{
		...
		WebResource webResource = client.resource("http://localhost:8080/gestionWebService-0.0.1-SNAPSHOT/rest/studentService/getStudent/" + id);
	...
	public Student getStudentByMail(String mail)
	{
		...
		WebResource webResource = client.resource("http://localhost:8080/gestionWebService-0.0.1-SNAPSHOT/rest/studentService/getStudentByMail/" + mail);
	...
	public List<Student> getAllStudents()
	{
		...
		WebResource webResource = client.resource("http://localhost:8080/gestionWebService-0.0.1-SNAPSHOT/rest/studentService/getAllStudents");
	...
	public void deleteStudent(int id)
	{
		...
		WebResource webResource = client.resource("http://localhost:8080/gestionWebService-0.0.1-SNAPSHOT/rest/studentService/deleteStudent");
	...
	public void updateStudent(int oldStudentId, Student student)
	{
		...
		WebResource webResource =
				client.resource("http://localhost:8080/gestionWebService-0.0.1-SNAPSHOT/rest/studentService/updateStudent/" + oldStudentId);
	...
	public List<Student> searchStudent(String firstName, String lastName)
	{
		...
		WebResource webResource =
				client.resource("http://localhost:8080/gestionWebService-0.0.1-SNAPSHOT/rest/studentService/searchStudent")

...
public class StudentService implements IStudentService
{
	...
	@Path("/deleteStudent")
	@Consumes(MediaType.APPLICATION_JSON)
	public void deleteStudent(JSONObject idInput)
	{
	...
	@Path("/searchStudent")
	@Produces(MediaType.APPLICATION_JSON)
	public List<Student> searchStudent(@QueryParam("firstName") String firstName, @QueryParam("lastName") String lastName)
	{
